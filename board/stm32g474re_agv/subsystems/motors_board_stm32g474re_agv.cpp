...
namespace
{
  ...
  // motor mapping:
  // motor0 = front_left  (physical motor0, direction inverted by a/b swap)
  // motor1 = front_right (physical motor1)
  // motor2 = rear_left   (physical motor2, direction inverted by a/b swap)
  // motor3 = rear_right  (physical motor3)
  //
