...
namespace
{
  ...
  static bool read_capture_normal(void *platform_handle, std::uint8_t channel, std::uint32_t &high_ticks, std::uint32_t &period_ticks, std::uint32_t &time_ms)
  {
  ...
  static bool read_capture_inverted(void *platform_handle, std::uint8_t channel, std::uint32_t &high_ticks, std::uint32_t &period_ticks, std::uint32_t &time_ms)
  {
  ...
  // encoder0: tim3_ch1 (pc6)
  // encoder1: tim3_ch2 (pc7)
  // encoder2: tim3_ch3 (pc8)
  // encoder3: tim3_ch4 (pc9)
  static const encoder_api::encoder_input k_encoders[] =
  {
    { static_cast<void *>(k_tim3), static_cast<std::uint8_t>(TIM_CHANNEL_1), &k_encoder_cap_normal },
    { static_cast<void *>(k_tim3), static_cast<std::uint8_t>(TIM_CHANNEL_2), &k_encoder_cap_inverted },
    { static_cast<void *>(k_tim3), static_cast<std::uint8_t>(TIM_CHANNEL_3), &k_encoder_cap_normal },
    { static_cast<void *>(k_tim3), static_cast<std::uint8_t>(TIM_CHANNEL_4), &k_encoder_cap_inverted }
  };
