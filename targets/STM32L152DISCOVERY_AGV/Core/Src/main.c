...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(IMU_CS_AG_GPIO_Port, IMU_CS_AG_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(IMU_CS_M_GPIO_Port, IMU_CS_M_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : IMU_CS_AG_Pin */
  GPIO_InitStruct.Pin = IMU_CS_AG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(IMU_CS_AG_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : IMU_CS_M_Pin */
  GPIO_InitStruct.Pin = IMU_CS_M_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(IMU_CS_M_GPIO_Port, &GPIO_InitStruct);
