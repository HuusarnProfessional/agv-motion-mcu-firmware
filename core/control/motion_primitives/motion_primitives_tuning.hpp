...
namespace motion_primitives_tuning
{
  ...
  constexpr std::int32_t k_rotate_delta_min_request_yaw_rate_mdeg_s = 60000;
  constexpr std::int32_t k_rotate_delta_min_yaw_rate_mdeg_s = 60000;
  ...
  constexpr std::int32_t k_rotate_delta_default_rotation_min_drive_u = 400;
  constexpr std::int32_t k_rotate_delta_default_rotation_startup_drive_u = 700;
